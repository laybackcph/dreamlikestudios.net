...
class LaybackPartnersMain 
{
	...
	public function __construct() 
	{
		...
		$this->sPluginName  	= 'Partners';
		$this->sTextDomain  	= 'layback';
		$this->sPluginNameTag  	= 'partners';
		$this->sPrefix 			= 'dlpa';
	...
	private function load_dependencies() 
	{
		...
		$this->oPublic 			= new LaybackPartnersPublic($this->sTextDomain, $this->sPrefix, $this->sPluginName, $this->sPluginNameTag, $this->oFunctions);
