...
class LaybackTeamMain 
{
	...
	public function __construct() 
	{
		...
		$this->sPluginName  	= 'The team';
		$this->sTextDomain  	= 'layback';
		$this->sPluginNameTag  	= 'team';
		$this->sPrefix 			= 'dltt';
	...
	private function load_dependencies() 
	{
		...
		$this->oPublic 			= new LaybackTeamPublic($this->sTextDomain, $this->sPrefix, $this->sPluginName, $this->sPluginNameTag, $this->oFunctions);
