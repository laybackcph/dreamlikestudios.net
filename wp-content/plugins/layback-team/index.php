...
defined('ABSPATH') or die('No script kiddies please!'); 
    /*
     *  Plugin Name: The team
     *  Plugin URI: https://laybackcph.dk
     *  Description: The team Plugin
     *  Version: 1.0.0
     *  Author: Layback
...
/********************************************************************************************************************/
    ...
    add_action('init', 'init_language_text_layback_team');
    function init_language_text_layback_team() 
    {
...
/********************************************************************************************************************/
    ...
    $oLaybackTeamMain = new LaybackTeamMain();