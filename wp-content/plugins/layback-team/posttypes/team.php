<?php
	...
	add_action( 'init', 'lb_posttype_custom_team' );
	function lb_posttype_custom_team() {
	   
	   // Write these variables as all lowercase

		// Post variables
		$singular 				= __('The team', 'layback');
		$multiple 				= __('The team', 'layback');
		$description 			= __( 'The team posttype', 'layback' );
