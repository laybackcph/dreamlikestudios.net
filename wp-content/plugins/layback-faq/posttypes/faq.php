<?php
	...
	add_action( 'init', 'lb_posttype_custom_faq' );
	function lb_posttype_custom_faq() {
	   
	   // Write these variables as all lowercase

		// Post variables
		$singular 				= __('FAQ', 'layback');
		$multiple 				= __('FAQ', 'layback');
		$description 			= __( 'FAQ posttype', 'layback' );
