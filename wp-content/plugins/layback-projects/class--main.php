...
class LaybackProjectsMain 
{
	...
	public function __construct() 
	{
		...
		$this->sPluginName  	= 'Projects';
		$this->sTextDomain  	= 'layback';
		$this->sPluginNameTag  	= 'projects';
		$this->sPrefix 			= 'dlpr';
	...
	private function load_dependencies() 
	{
		...
		$this->oPublic 			= new LaybackProjectsPublic($this->sTextDomain, $this->sPrefix, $this->sPluginName, $this->sPluginNameTag, $this->oFunctions);
